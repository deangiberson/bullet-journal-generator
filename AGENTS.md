...
- Accessible by simplicity: minimal controls, clear pointer interactions, simple add/remove (big X), and undo/redo for layout edits. Keyboard shortcuts and command palette are currently out of scope.
